...
var tmplSource = fs.readFileSync('template.html', 'utf-8'),
    ...
    data = JSON.parse(fs.readFileSync('assets/shows.json', 'utf-8'));  //made it into workable list type intformation + reoder things + include and skip over //
//lowdash is here
...
var markup = template({byArtist:byArtist})  //this helps you mark as a key, you type what you want template.html and then it changes in the index.html//
